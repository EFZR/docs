...
dotnet new webapi -o ./Service/Service.n-tier
...
dotnet sln add ./Service/Service.n-tier
...
dotnet add ./Service/Service.n-tier/ package Automapper --version 12.0.1
dotnet add ./Service/Service.n-tier/ package AutoMapper.Extensions.Microsoft.DependencyInjection --version 12.0.1
dotnet add ./Service/Service.n-tier/ package Microsoft.AspNetCore.Authentication.JwtBearer --version 7.0.7
dotnet add ./Service/Service.n-tier/ package Microsoft.AspNetCore.OpenApi --version 7.0.10
dotnet add ./Service/Service.n-tier/ package Swashbuckle.AspNetCore
...
dotnet add ./Service/Service.n-tier/ reference ./Transversal/Transversal.Common/Transversal.Common.csproj
dotnet add ./Service/Service.n-tier/ reference ./Transversal/Transversal.Logging/Transversal.Logging.csproj
dotnet add ./Service/Service.n-tier/ reference ./Transversal/Transversal.Mapping/Transversal.Mapping.csproj
dotnet add ./Service/Service.n-tier/ reference ./Infrastructure/Infrastructure.Data/Infrastructure.Data.csproj
dotnet add ./Service/Service.n-tier/ reference ./Infrastructure/Infrastructure.Interface/Infrastructure.Interface.csproj
dotnet add ./Service/Service.n-tier/ reference ./Infrastructure/Infrastructure.Repository/Infrastructure.Repository.csproj
dotnet add ./Service/Service.n-tier/ reference ./Domain/Domain.Core/Domain.Core.csproj
dotnet add ./Service/Service.n-tier/ reference ./Domain/Domain.Entity/Domain.Entity.csproj
dotnet add ./Service/Service.n-tier/ reference ./Domain/Domain.Interface/Domain.Interface.csproj
dotnet add ./Service/Service.n-tier/ reference ./Application/Application.DTO/Application.DTO.csproj
dotnet add ./Service/Service.n-tier/ reference ./Application/Application.Interface/Application.Interface.csproj
dotnet add ./Service/Service.n-tier/ reference ./Application/Application.Main/Application.Main.csproj
